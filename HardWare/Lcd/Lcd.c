...
void lcd_show_status(uint16_t x, uint16_t y,uint16_t sensor_status)
{
    if(sensor_status == 1)//正常
    {
        lcd_show_string(x, y, 200, 16, 16, "normal  ", BLUE);
    }
    else //异常
    {
        lcd_show_string(x, y, 200, 16, 16, "abnormal", RED);
    }
}
